                    ...
                    if update.get('message', False):
                        ...
                        for step in self._next_step_handlers:
                            if str(update['message']['chat']['id']) == step:
                                if threaded_run:
                                    executor.submit(self._next_step_handlers[step]['func'], Message(update['message'], self), *self._next_step_handlers[step]['args'])
                                else:
                                    self._next_step_handlers[step]['func'](Message(update['message'], self), *self._next_step_handlers[step]['args'])
